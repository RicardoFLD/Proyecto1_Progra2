...
public class getCatalogServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from catalogo where estado = 'En Venta'");
            ...
            out.println("<th scope=\"col\">Comprar</th>");
            ...
            while (resultSet.next()) {
                out.println("<tr onclick=\"window.location.href = 'modificar_carro.jsp?id=" + resultSet.getString("id") + "';\">");
                ...
                out.println("<td>" + resultSet.getString("tipo") + "</td>");
                out.println("<td>" + resultSet.getString("estado") + "</td>");
                out.println("<td>" + resultSet.getInt("Año") + "</td>");
                out.println("<td> <a type=\"button\" class=\"btn btn-primary\" href=\"comprar.jsp?id=" + resultSet.getString("id") + "\">Comprar</a> </td>");
                out.println("<td> <a type=\"button\" class=\"btn btn-danger\" href=\"eliminar.jsp?id=" + resultSet.getString("id") + "\">Eliminar</a> </td>");
                out.println("</tr>");
            }
            out.println("</tbody>");
            out.println("</table>");
