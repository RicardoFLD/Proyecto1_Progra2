...
public class vendidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from catalogo where estado = 'Vendido'");
            ...
            while (resultSet.next()) {
                ...
                out.println("<td> <a type=\"button\" class=\"btn btn-primary\" href=\"vender.jsp?id=" + resultSet.getString("id") + "\">Vender</a> </td>");
                out.println("</tr>");
            }
            out.println("</tbody>");
            out.println("</table>");
