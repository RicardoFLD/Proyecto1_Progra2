    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from carros where Marca=" + Marca);
            resultSet.next();
            ...
            out.println("        <a class=\"btn btn-info\" href=\"invertarioCar\">Go back</a>");
            out.println("    </div>");
            out.println("    <div class='card-body'>");
            out.println("        <form action='editarProductos' method='post'>");
            ...
            out.println("                    </div>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Modelo") + "' name='txtModelo' type='text' class='form-control' id='txtModelo' placeholder='Jimnt' required>");
            out.println("                        <label for='txtName'>Name</label>");
            out.println("                    </div>        ");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Año") + "' name='txtAño' type='text' class='form-control' id='txtAño' placeholder='2013' required>");
            out.println("                        <label for='txtAño'>Año</label>");
            out.println("                    </div> ");
            out.println("                </div>");
            out.println("                <div class='col'>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getInt("Estilo") + "' name='txtEstilo' type='number' class='form-control' id='txtEstilo' placeholder='Uso diario' required>");
            out.println("                        <label for='txtEstilo'>Estilo</label>");
            out.println("                    </div>  "); 
            out.println("                </div>");
            out.println("            </div>");
            out.println("            <hr>");
            out.println("            <button type='submit' class='btn btn-primary' style='float: right;margin-left:3px'>Update</button>");                        
            out.println("               <a class=\"btn btn-danger\" style='float: right' href='deleteProducts?Id=" + resultSet.getInt("Id") + "'>Delete</a>");
            out.println("        </form>");                        
            out.println("    </div>");            
            out.println("</div>");
            out.println("</div>");
